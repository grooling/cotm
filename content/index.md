...
# Campaign Overview
<!-- QueryToSerialize: TABLE WITHOUT ID file.link as "No.", dateformat(date(date), "yy-MM-dd") as "Date", description as "Synopsis" WHERE contains(lower(type),"session") AND file.name != "New Session Template" SORT date ASC -->
<!-- SerializedQuery: TABLE WITHOUT ID file.link as "No.", dateformat(date(date), "yy-MM-dd") as "Date", description as "Synopsis" WHERE contains(lower(type),"session") AND file.name != "New Session Template" SORT date ASC -->
...
| [[Sessions/015.md\|015]] | 24-07-28 | Cepha's schema, treasure, and an attack by a familiar, unmasked killer.    |
...
| [[People/Player Characters/Bariac Cast-Ironfist.md\|Bariac Cast-Ironfist]] | Montana  | Dwarven chef and cleric from Mror Holds   |
...
| [[People/Player Characters/Zinnia Rose.md\|Zinnia Rose]]                   | Spooky   | Glamorous tiefling bard from Tronish      |
<!-- SerializedQuery END -->

# Locations
<!-- QueryToSerialize: TABLE WITHOUT ID file.name as "Place", nation as "Nation", description as "Description" from "Places" WHERE contains(lower(type),"place") SORT date ASC -->
<!-- SerializedQuery: TABLE WITHOUT ID file.name as "Place", nation as "Nation", description as "Description" from "Places" WHERE contains(lower(type),"place") SORT date ASC -->
...
| index         | \-         | \-                                                           |
| index         | Aerenal    | Isolationist Elven island continent to the south             |
| index         | \-         | \-                                                           |
| index         | \-         | \-                                                           |
| Sterngate     | Breland    | Fortress at border between Breland and Darguun               |
| index         | \-         | \-                                                           |
| Starilaskur   | \-         | Major lightning rail stop in Breland                         |
